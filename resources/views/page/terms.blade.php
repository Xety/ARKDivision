@extends('layouts.app')
{!! config(['app.title' => 'Conditions Générales d\'Utilisation']) !!}
...
<div class="container mt-6">
    <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <p>
                    Les utilisateurs doivent traiter les autres utilisateurs, la modération et l'administration du Forum avec respect. Les commentaires irritants, injurieux et irrespectueux ne sont pas tolérés. De même, les commentaires potentiellement faux ou pouvant porter préjudice à un individu ou une entité ne sont pas tolérés.
                </p>
                <p>
                    Il est important de faire la différence entre un jugement/attaque personnelle et une opinion. Un utilisateur est dans son droit de réfuter votre argumentaire en faisant preuve de respect et en exposant ses propres arguments pour appuyer son opinion, et ceci ne constitue pas nécessairement un jugement ou une attaque personnelle. Veuillez vous référer à l'équipe de modération en cas de doute.
                </p>
                <p>
                ...
                <p>
                    La publication de contenus illégaux est à proscrire afin de protéger cette plateforme. De même, les contenus violents, obscènes ou discriminatoires ne seront pas tolérés.
                </p>
                <p>
                ...
                <p>
                    Avant de publier un message, naviguez dans les différentes sections afin de repérer la section appropriée. Merci de publier votre message dans une seule section. Avant de poser une question, veillez à rechercher dans les sujets déjà existants pour savoir si une question identique à la vôtre a déjà été posée et répondue, et ainsi éviter la redite.
                </p>
                <p>
                ...
                <p>
                    Afin de permettre à tous d’accéder le plus rapidement possible à une information pertinente, veillez à éviter les commentaires qui n’apportent aucune information supplémentaire et qui ne font qu’émettre une opinion personnelle sur le débat en cours.
                </p>
                <p>
                ...
                <p>
                    Les utilisateurs sont invités à ne pas divulguer leurs adresses et numéros de téléphone, et ceux d’autres utilisateurs. Si vous souhaitez partager ces informations, nous vous prions de le faire de manière privée. De même, la publication de contenus de conversations privées est prohibée.
                </p>
                <p>
                ...
                <p>
                    Les informations personnelles recueillies au travers de votre compte font l'objet uniquement d’un traitement sur la plateforme et ne sont pas communiquées à des tiers.
                </p>
                <p>
                    Afin d’optimiser notre site Internet et mieux adapter le contenu en fonction des visiteurs, nous recueillons des données techniques grâce à l’outil d’analyse « Google Analytics ». Cela inclut le type de navigateur que vous utilisez, l’adresse IP ou celle de votre fournisseur d’accès Internet, le système d’exploitation, les différentes pages consultées ainsi que la date et l’heure de votre visite sur notre site.
                </p>
                <p>
                ...
                <p>
                    Notre plateforme utilise également des cookies pour suivre l’utilisation du site et « mémoriser » si besoin des informations comme des préférences de langue ou rappel d’identifiants. Dans le cas d’intégration de vidéos dans les pages de notre site Internet, certaines plateformes vidéo utilisent également des cookies à des fins de statistiques anonymes.
                </p>
                <p>
                ...
                <p>
                    L’association ARK Division France ne saurait être tenue responsable des informations publiées sur la plateforme. Toutes les informations publiées ne peuvent être vérifiées et peuvent comporter des renseignements erronés ou ne respectant pas les règles énoncées ci-dessus. En publiant du contenu sur le Forum, vous acceptez de renoncer à tout droit d’auteur sur ce contenu.
                </p>
                <p>
