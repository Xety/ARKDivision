    ...
    public function run()
    {
        ...
        $rewards = [
            [
                ...
                'data' => '{"command":"giveitem %s Blueprint\'/Game/Mods/YashiFactory/manticorestatue/medium/PrimalItemStructure_Furniture_manticoreM.PrimalItemStructure_Furniture_manticoreM\' 1 0 0"}',
                'rule' => '1',
                'created_at' => $now,
                'updated_at' => $now
            ],
            [
                ...
                'type' => 'Xetaravel\Events\Donation\NewDonationEvent',
                'data' => '{"command":"giveitem %s Blueprint\'/Game/Mods/YashiFactory/statuedragon/medium/PrimalItemStructure_Furniture_dragonM.PrimalItemStructure_Furniture_dragonM\' 1 0 0"}',
                'rule' => '1',
                'created_at' => $now,
                'updated_at' => $now
            ],
            [
                ...
                'type' => 'Xetaravel\Events\Donation\NewDonationEvent',
                'data' => '{"command":"giveitem %s Blueprint\'/Game/Mods/YashiFactory/gorillastatue/medium/PrimalItemStructure_Furniture_gorillaM.PrimalItemStructure_Furniture_gorillaM\' 1 0 0"}',
                'rule' => '1',
                'created_at' => $now,
                'updated_at' => $now
            ]
